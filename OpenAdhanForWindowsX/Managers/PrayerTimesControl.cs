...
namespace OpenAdhanForWindowsX.Managers
{
    public sealed class PrayerTimesControl
    {
        ...
        public void scheduleAdhans(MainAppForm form)
        {
            if (this.prayer_datetimes is null) { this.calculatePrayerTimes(); }
        ...
        private void invokeFormBoldnessUpdate(MainAppForm form, string prayer)
        {
        ...
        public void playAdhanFile(string audio_file = null)
        {
            ...
            try
            {
                ...
                bool shouldMuteAllApps = this.rsh.SafeLoadBoolRegistryValue(RegistrySettingsHandler.muteAllAppsOnAdhanPlayingKey);
                if (shouldMuteAllApps)
                {
                    audioManager.MuteOtherApplications();
                }
                ...
                if (shouldMuteAllApps)
                {
                    ...
                    playbackStoppedHandler = (sender, e) =>
                    {
        ...
        private void delayedUpdatePrayerTimes(MainAppForm form)
        {
